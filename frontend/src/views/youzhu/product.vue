<template>
    <el-row>
        ...
        <el-row class="tools">
            <el-col :span="10">
                <el-input size="small" v-model="keys" placeholder="请输入产品标题"></el-input>
            </el-col>
        ...
        <el-table :data="depList" stripe v-loading="isLoading" >
            ...
            <el-table-column prop="depName" label="公司名称" show-overflow-tooltip></el-table-column>
            <el-table-column prop="title" label="产品标题"></el-table-column>
            <el-table-column prop="type" label="产品类型"></el-table-column>
            <el-table-column prop="content" label="分享文案" show-overflow-tooltip></el-table-column>
            <el-table-column prop="image" label="分享图片">
              <template slot-scope="scope">
                <img :src='scope.row.image.uri' />
              </template>
            </el-table-column>
            <el-table-column prop="from" label="出发地"></el-table-column>
            <el-table-column prop="to" label="目的地"></el-table-column>
            <el-table-column prop="stime" label="出发时间" :formatter="dateFormat" width="160"></el-table-column>
      ...
      <el-dialog :title="'产品 -- '+ (title || '新增')" :visible.sync="isDialogVisible" @close="onFormClose">
        <el-form :model="formData" :rules="rules" ref="dialogForm" label-width="90px" @keyup.enter.native="onSubmit" size='small'>
          <el-form-item label="产品标题" prop="title">
            <el-input v-model="formData.title" name="title" placeholder="产品标题"></el-input>
          </el-form-item>
          <el-form-item label="分享文案" prop="content">
            <el-input v-model="formData.content" name="content" type="textarea" placeholder="分享文案"></el-input>
          </el-form-item>
          <el-form-item label="出发地" prop="from">
            <el-input v-model="formData.from" name="from" placeholder="出发地"></el-input>
          </el-form-item>
          <el-form-item label="目的地" prop="to">
            <el-input v-model="formData.to" name="to" placeholder="目的地"></el-input>
          </el-form-item>
          <el-form-item label="出发时间" prop="stime">
            <el-date-picker
